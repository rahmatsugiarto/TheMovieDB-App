...
class TrendingSeeAllTvAdapter :
    PagingDataAdapter<TrendingSeeAllTvEntity, TrendingSeeAllTvAdapter.MyViewHolder>(
        TvComparatorTrending
    ) {

    class MyViewHolder(private val binding: ItemRowMovieDescBinding) :
        RecyclerView.ViewHolder(binding.root) {

        fun bind(tv: TrendingSeeAllTvEntity) {
...
object TvComparatorTrending : DiffUtil.ItemCallback<TrendingSeeAllTvEntity>() {
    override fun areItemsTheSame(
        oldItem: TrendingSeeAllTvEntity,
        newItem: TrendingSeeAllTvEntity
    ): Boolean {
