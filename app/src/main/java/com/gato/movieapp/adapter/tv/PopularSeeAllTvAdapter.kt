...
class PopularSeeAllTvAdapter :
    PagingDataAdapter<PopularSeeAllTvEntity, PopularSeeAllTvAdapter.MyViewHolder>(
        TvComparatorPopular
    ) {
    ...
    class MyViewHolder(private val binding: ItemRowMovieDescBinding) :
        ...
        fun bind(tv: PopularSeeAllTvEntity) {
...
object TvComparatorPopular : DiffUtil.ItemCallback<PopularSeeAllTvEntity>() {
    override fun areItemsTheSame(
        oldItem: PopularSeeAllTvEntity,
        newItem: PopularSeeAllTvEntity
    ): Boolean {
